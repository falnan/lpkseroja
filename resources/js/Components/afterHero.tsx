    ...
    return (
        <section className="relative max-w-screen-xl mx-auto py-4 px-4 md:px-8">
            ...
            <div className="relative z-10 gap-5 items-center">
                <div className="flex-1 max-w-lg py-5 sm:mx-auto sm:text-center">
                    ...
                    <p className="text-gray-500 leading-relaxed mt-3">
                        Nam erat risus, sodales sit amet lobortis ut, finibus
                        eget metus. Cras aliquam ante ut tortor posuere feugiat.
