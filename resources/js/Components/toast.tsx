        ...
        <div className="bg-indigo-600">
            <div className="max-w-screen-xl mx-auto px-4 py-1 flex items-start justify-between text-white md:px-8">
                <div className="flex gap-x-4">
                    <div className="self-center size-8 flex-none rounded-lg bg-indigo-800 flex items-center justify-center">
                        <svg
                            className="size-5"
                    ...
                    <p className="py-2 font-medium">{props.children}</p>
                </div>
                <button
                    onClick={props.clickForClose}
